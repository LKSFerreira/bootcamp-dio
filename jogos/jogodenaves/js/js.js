function start() { // Inicio da fun��o start() 
    ...
    var dificuldadeInimigo1 = 0.18;
    var dificuldadeInimigo2 = 1.5;
    var energiaAtual = 3;
    var pontos = 0;
    var salvos = 0;
    var perdidos = 0;
    ...
    function movefundo() { //Fun��o que movimenta o fundo do jogo
    ...
    function moveinimigo1() { //função que movimenta o inimigo1 (helicóptero)
    ...
    function colisao() {
        ...
        if (colisao3.length > 0) {
            ...
            pontos = pontos + 100;
            velocidade = velocidade + dificuldadeInimigo1;
        ...
        if (colisao5.length > 0) {
            ...
            velocidadeInimigo2 = velocidadeInimigo2 + dificuldadeInimigo2;
            velocidadeAmigo++;
            salvos++;
    ...
    function reposicionaInimigo2() {
        ...
        var tempoColisao4 = window.setInterval(reposiciona4, 4500);
